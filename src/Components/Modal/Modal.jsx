...
function Modal({
  ...
  const handleDelete = () => {
    const filteredLevel = level.filter((item) => item._id !== del);
    setDelModal(false);

    setLevel(filteredLevel);
  };
  ...
  return (
    <>
      ...
      <div className={`modal-del ${delModal ? "modal-del--active" : ""}`}>
        <div className="modal-del-inner">
          <h2 className="modal__del-heading">Are you sure</h2>
